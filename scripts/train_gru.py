...
from src.models.gru import save_gru, train_gru
...
def main():
    ...
    model, scalers, current_metrics, soc_metrics = train_gru(
        train_df=train_df,
        val_df=val_df,
        test_df=test_df,
        features=features,
    ...
    print("Saving model...")
    save_gru(model, scalers, cfg=cfg, features=features, name=model_name)
